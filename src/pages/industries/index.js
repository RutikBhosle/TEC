...
const fetchAllIndustryPosts = async () => {
  const query = `
    *[_type == "industryPost"]
    {
      title,
...
const IndustriesIndex = () => {
  ...
  const { data, isLoading, error, refetch } = useQuery({
    queryKey: ["allIndustryPosts"],
    queryFn: () => fetchAllIndustryPosts(),
  });
  ...
  const categoryTitle = "All Industries";

  return (
    <>
      <HeadMeta
        metaTitle="All Industries - Sector News, Profiles & Analysis | Star Prime"
        metaDesc="Read the latest featured articles, founder interviews, and in-depth business case studies across all industry vertical sectors."
      />
      <HeaderOne />
      ...
      <section className="industry-hero-cover animate-fade">
        <div className="hero-cover-container">
          <div className="hero-cover-header">
            <span className="hero-eyebrow">All Sectors Focus</span>
            <h1 className="hero-cover-title">All Industries Focus</h1>
            <p className="hero-cover-desc">
              Explore outstanding leadership strategies, pioneering founder profiles, and in-depth business case studies across all industry verticals.
            </p>
          ...
          {isLoading ? (
            ...
            <div className="error-alert-dark" style={{ border: "none", background: "transparent", padding: 0 }}>
              <DataErrorPlaceholder section="All Industries" refetch={refetch} />
            </div>
          ) : posts.length === 0 ? (
              ...
              {posts[0] && (
                ...
                >
                  ...
                  <div className="primary-hero-content">
                    <span className="primary-hero-category">{posts[0].category?.title || "Industry"} Highlight</span>
                  ...
                  posts.slice(1, 7).map((post, idx) => (
                    ...
                    >
                      ...
                      <div className="secondary-hero-details">
                        <span className="secondary-hero-category">{post.category?.title || "Industry"}</span>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="feed-card-content">
                          <span className="feed-card-category">{post.category?.title || "Industry"}</span>
